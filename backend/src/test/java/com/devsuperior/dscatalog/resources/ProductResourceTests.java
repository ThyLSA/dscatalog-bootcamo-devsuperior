...
public class ProductResourceTests {
	...
	void setUp() throws Exception {
		...
		newProductDTO = Factory.createProductDTO();
		...
		when(service.include(any())).thenReturn(productDTO);
		...
		doThrow(DatabaseIntegrityException.class).when(service).delete(dependentId);
	}
	...
	@Test
	public void includeShouldReturnStatusCreatedAndProductDTO() throws Exception {
